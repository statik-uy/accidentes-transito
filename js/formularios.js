...
const sendMail = async (asunto, email, mensaje) => {
  ...
  if (res) {
    ...
    const notificationMessage = document.getElementById("notification-message");
    const toast = new bootstrap.Toast(toastElement);
    notificationMessage.innerHTML = "La solicitud de contacto fue enviada!";
    toast.show();
...
if (formularioConsulta) {
  formularioConsulta.addEventListener("submit", (event) => {
    ...
    const notificationMessage = document.getElementById("notification-message");
    const toast = new bootstrap.Toast(toastElement);
    notificationMessage.innerHTML = "Procesando solicitud";
    toast.show();
